...
import { Bell, Globe, LogOut, Search, User } from "lucide-react";
      ...
      <div className="flex items-center justify-between h-full px-6">
        <div className="flex items-center gap-4">
          ...
          <div className="relative max-w-md">
            ...
            <Input placeholder="Search orders, customers, products..." className="pl-10 w-80" />
          </div>
        </div>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem className="flex flex-col items-start gap-1 p-4">
                ...
                <span className="text-sm text-muted-foreground">Diesel level below 500L threshold</span>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
